...
class GroupController extends Controller
{
    ...
    public function groups_per_day(Request $request)
    {
        ...
        $groups = $groupsQuery->with(['sessions.exceptions'])->orderBy($sortBy, $sortDirection)->paginate($perPage);
    ...
    {
        $group = Group::with(['teacher.user', 'level', 'students.user', 'sessions.exceptions', 'students.level'])->findOrFail($id);
